...
// Simple full-page redirect into the server-side OAuth flow — this has to
// be a real navigation, not a fetch, since the browser needs to actually
// land on accounts.google.com for the user to approve the login.
